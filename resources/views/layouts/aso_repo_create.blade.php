...
@section('contents')
    ...
    @else
        ...
        <form action="/aso-repo" method="post" enctype="multipart/form-data">
            ...
            <h2>楽しさを共有しよう！</h2>
            <p style="padding: 5px;">imgタグ、aタグ、strongタグ、strikeタグ、pタグがお使いになれます。<br>
            画像を投稿して使用しますか？こちらから投稿できます→
            <a href="/aso-repo/img-create?aid={{$aid}}" target=" _blank"><img src="/img/form/img-create.png"></a></p>
